...
how a document looks and how to typeset it successfully.
...
The `\usepackage` command is described in a later lesson. 
...
information in the further details page.

--

# "More on: Basic LaTeX document structure"


## Running LaTeX

As [detailed earlier](../02), LaTeX documents are simply plain text. To see
